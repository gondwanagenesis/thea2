...
note: >
  DRAFT, distilled from Thea1 SOUL.md. The ONLY prose identity in the system -
  a keel, not a persona document. Everything else about her is demonstrated in
  the scenes, never described. Keep it to 2-3 lines; if you're tempted to add a
