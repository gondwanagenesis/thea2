// scripts/nightingale-live.ts — the S8 gate closer: one full LIVE Nightingale
...
//
// Usage: npx tsx scripts/nightingale-live.ts [--k 3] [--dry]
...
import { compose, type ComposedSystem } from '../src/app/compose.js';
...
try {
  ...
  const secs = Math.round((clock.epochMs() - t0) / 1000);
