...
module: M13
name: loop
syncedTo: v6-W1 P-FAST (2026-09-03 — the turn never throws: FA.1 turn-abort values, FA.2 snappy budgets + voice-door transport dial, FA.3 spawns off user turns, FA.4 repair on the voice door + bubble-shape gate composed; see "As built (P-FAST)")
stage: S4
